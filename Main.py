...
def generate_tree():
    ...
    p1 = Person('M', 'Ali', 'Yılmaz', datetime.date(1927,1,1), datetime.date(1997,1,1), None, None, 1)
    tree.append(p1)
    p2 = Person('F', 'Ayşe', 'Yılmaz', datetime.date(1930,1,1), datetime.date(2000,1,1), None, None, 1)
    add_spouse(p1, p2)
    
    # Generation 2 --------------------------------------------------------------------------------
    p3 = Person('F', 'Burcu', 'Çetin', datetime.date(1955,1,1), None, p1, p2, 2)
    add_child(p1, p2, p3)
    p4 = Person('M', 'Fatih', 'Çetin', datetime.date(1952,1,1), datetime.date(2020,1,1), None, None, 2)
    add_spouse(p3, p4)

    p5 = Person('M', 'Tolga', 'Yılmaz', datetime.date(1960,1,1), None, p1, p2, 2)
    add_child(p1, p2, p5)
    p6 = Person('F', 'Gözde', 'Yılmaz', datetime.date(1963,1,1), None, None, None, 2)
    add_spouse(p5, p6)

    p7 = Person('F', 'Beyza', 'Demir', datetime.date(1965,1,1), None, p1, p2, 2)
    add_child(p1, p2, p7)
    p8 = Person('M', 'Mehmet', 'Demir', datetime.date(1962,1,1), None, None, None, 2)
    add_spouse(p7, p8)

    p9 = Person('M', 'Osman', 'Yılmaz', datetime.date(1970,1,1), None, p1, p2, 2)
    add_child(p1, p2, p9)
    p10 = Person('F', 'Betül', 'Yılmaz', datetime.date(1973,1,1), None, None, None, 2)
    add_spouse(p9, p10)

    # Generation 3 --------------------------------------------------------------------------------
    p11 = Person('M', 'Berk', 'Çetin', datetime.date(1980,1,1), None, p4, p3, 3)
    add_child(p4, p3, p11)
    p12 = Person('F', 'Sıla', 'Çetin', datetime.date(1985,1,1), None, p4, p3, 3)
    add_child(p4, p3, p12)

    p13 = Person('M', 'Murat', 'Yılmaz', datetime.date(1988,1,1), None, p5, p6, 3)
    add_child(p5, p6, p13)
    p14 = Person('F', 'Ebru', 'Yılmaz', datetime.date(1993,1,1), None, p5, p6, 3)
    add_child(p5, p6, p14)

    p15 = Person('M', 'Ali', 'Demir', datetime.date(1990,1,1), None, p8, p7, 3)
    add_child(p8, p7, p15)
    p16 = Person('F', 'Tuğba', 'Demir', datetime.date(1995,1,1), None, p8, p7, 3)
    add_child(p8, p7, p16)

    p17 = Person('M', 'Yasin', 'Yılmaz', datetime.date(1998,1,1), None, p9, p10, 3)
    add_child(p9, p10, p17)
